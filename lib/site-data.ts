...
const englishCopy: Copy = {
  ...
  stats: [{ value: "Aug 6", label: "Release Date · 2026" }, { value: "90%", label: "Steam snapshot · 1,153 reviews" }, { value: "75", label: "Steam Achievements" }, { value: "6", label: "Supported Languages" }],
...
export const copy: Record<Locale, Copy> = {
  ...
  stats: [{ value: "08/06", label: "発売日 · 2026" }, { value: "90%", label: "Steam確認 · 1,153件" }, { value: "75", label: "Steam 実績" }, { value: "6", label: "対応言語" }],
  ...
  ko: {
    ...
    stats: [{ value: "08/06", label: "출시일 · 2026" }, { value: "90%", label: "Steam 확인 · 1,153개" }, { value: "75", label: "Steam 업적" }, { value: "6", label: "지원 언어" }],
  ...
  fr: {
    ...
    stats: [{ value: "06 août", label: "Sortie · 2026" }, { value: "90%", label: "Steam · 1 153 avis" }, { value: "75", label: "Succès Steam" }, { value: "6", label: "Langues supportées" }],
...
export const gameStats = [
  ...
  { label: "Steam Rating", value: "Very Positive — 90%" },
  { label: "Steam Reviews", value: "1,153 · checked Aug 12" },
