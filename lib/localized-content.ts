...
const englishUi: UiCopy = {
  ...
  localizedKeywordTitle: "Local-language keyword pages are not published yet.",
  localizedKeywordDescription: "The research corpus is currently edited in English. Publishing untranslated English paragraphs inside a Japanese, Korean or French page would be misleading, so these long-tail pages stay out of the localized index until their content is translated and reviewed.",
  localizedKeywordNotice: "This page is not indexed in this language yet. The core guides, FAQ and tools are available below in the selected language.",
};
...
const statTranslations: Record<Exclude<Locale, "en">, { label: string; value: string }[]> = {
  ja: [{ label: "開発元", value: "WILD WITS GAMES" }, { label: "パブリッシャー", value: "Curve Games" }, { label: "プラットフォーム", value: "Windows · SteamOS / Linux" }, { label: "ジャンル", value: "物語重視の管理 RPG / ビジュアルノベル" }, { label: "Steam 評価", value: "非常に好評 — 90%" }, { label: "Steam レビュー", value: "1,153件 · 8月12日確認" }, { label: "実績", value: "75" }, { label: "ナイツ能力値", value: "5掲載 · Luckは情報が分かれる" }, { label: "対応言語", value: "6" }],
  ko: [{ label: "개발사", value: "WILD WITS GAMES" }, { label: "배급사", value: "Curve Games" }, { label: "플랫폼", value: "Windows · SteamOS / Linux" }, { label: "장르", value: "내러티브 경영 RPG / 비주얼 노벨" }, { label: "Steam 평가", value: "매우 긍정적 — 90%" }, { label: "Steam 리뷰", value: "1,153개 · 8월 12일 확인" }, { label: "업적", value: "75" }, { label: "나이트 스탯", value: "5개 표시 · Luck은 충돌 있음" }, { label: "지원 언어", value: "6" }],
  fr: [{ label: "Développeur", value: "WILD WITS GAMES" }, { label: "Éditeur", value: "Curve Games" }, { label: "Plateforme", value: "Windows · SteamOS / Linux" }, { label: "Genre", value: "RPG de gestion narratif / visual novel" }, { label: "Note Steam", value: "Très positive — 90 %" }, { label: "Avis Steam", value: "1 153 · vérifié le 12 août" }, { label: "Succès", value: "75" }, { label: "Stats des Chevaliers", value: "5 listées · conflit sur Luck" }, { label: "Langues supportées", value: "6" }],
};
